...
class PlatformController extends AbstractController
{
    ...
    /**
     * @Route("/{id}", name="app_backoffice_platform_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="app_backoffice_platform_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name="app_backoffice_platform_delete", methods={"POST"})
     */
