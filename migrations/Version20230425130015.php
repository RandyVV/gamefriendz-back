 ...
 */
final class Version20230425130015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message ADD content_id INT DEFAULT NULL, CHANGE see see TINYINT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message DROP content_id, CHANGE see see TINYINT(1) NOT NULL');
    }
}
